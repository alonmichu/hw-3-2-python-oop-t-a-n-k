...
p_sh_a_1 = DB.create_product(p_1, shop_1, 12, Decimal(23.20))
p_sh_a_2 = DB.create_product(p_1, shop_2, 3, Decimal(24.00))
p_sh_a_3 = DB.create_product(p_2, shop_2, 5, Decimal(25.50))
p_sh_a_4 = DB.create_product(p_3, shop_3, 8, Decimal(105))
p_sh_a_5 = DB.create_product(p_4, shop_3, 25, Decimal(15.35))
p_sh_a_6 = DB.create_product(p_5, shop_3, 4, Decimal(180.50))
p_sh_a_7 = DB.create_product(p_5, shop_2, 2, Decimal(155.60))
